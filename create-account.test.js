...
describe('createAccount', function() {
	...
	describe('deposit', function() {
		...
		it('adds the amount to the account balance', function() {
			expect(account.deposit('1234', 100)).toBe('Successfully deposited $100. Current balance: $100.');
			expect(account.deposit('1234', 200)).toBe('Successfully deposited $200. Current balance: $300.');
	...
	describe('withdraw', function() {
		...
		it('subtracts the amount from the account balance', function() {
			expect(bigAccount.withdraw('4321', 250)).toBe('Successfully withdrew $250. Current balance: $9750.');
			expect(bigAccount.withdraw('4321', 1000)).toBe('Successfully withdrew $1000. Current balance: $8750.');
		});
